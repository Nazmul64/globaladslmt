...
<section class="pp-main">
    <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="pp-card fade-up">
            ...
            <div class="pp-card__body">
                ...
                <div class="pp-content">
                    {!! nl2br(e($privacy_policy->description)) !!}
                </div>
        ...
        <div class="pp-empty fade-up">
            ...
            <h4>No Child Safety Policy Available</h4>
            <p>We are currently updating our child safety policy. Please check back later.</p>
...
<footer class="pp-footer">
    <div class="container">
        <p>
            ...
            &nbsp;|&nbsp;
            <a href="{{ route('privacy.index') }}">Child Safety Standards</a>
        </p>
    </div>
</footer>
