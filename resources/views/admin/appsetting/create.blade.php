...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">
            <i class="bi bi-plus-circle me-2"></i>Create New App Settings
        </h4>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('invalid_click_limit', 5) }}"
                                       placeholder="e.g., 5">
                            ...
                            <div class="col-12">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('view_before_click_view_target', 10) }}"
                                       placeholder="e.g., 10">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('task_break_time_minutes', 5) }}"
                                       placeholder="5">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('button_timer_seconds', 30) }}"
                                       placeholder="30">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="form-check form-switch form-switch-lg mb-0 ps-0 d-flex align-items-center">
                                                        <input class="form-check-input ms-0 me-3 custom-toggle-switch" 
                                                               ...
                                                               value="yes" 
                                                               {{ old('stario_timer_status', 'yes') == 'yes' ? 'checked' : '' }}
                                                               onchange="updateTimerSwitchBadge('stario', this.checked)">
                                                    </div>
                                                    <span id="stario_timer_badge" class="badge px-3 py-2 fs-6 {{ old('stario_timer_status', 'yes') == 'yes' ? 'bg-success' : 'bg-danger' }}">
                                                        <i class="bi {{ old('stario_timer_status', 'yes') == 'yes' ? 'bi-check-circle' : 'bi-x-circle' }} me-1"></i>
                                                        {{ old('stario_timer_status', 'yes') == 'yes' ? 'Yes (Active)' : 'No (Disabled)' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="form-check form-switch form-switch-lg mb-0 ps-0 d-flex align-items-center">
                                                        <input class="form-check-input ms-0 me-3 custom-toggle-switch" 
                                                               ...
                                                               value="yes" 
                                                               {{ old('admob_timer_status', 'yes') == 'yes' ? 'checked' : '' }}
                                                               onchange="updateTimerSwitchBadge('admob', this.checked)">
                                                    </div>
                                                    <span id="admob_timer_badge" class="badge px-3 py-2 fs-6 {{ old('admob_timer_status', 'yes') == 'yes' ? 'bg-success' : 'bg-danger' }}">
                                                        <i class="bi {{ old('admob_timer_status', 'yes') == 'yes' ? 'bi-check-circle' : 'bi-x-circle' }} me-1"></i>
                                                        {{ old('admob_timer_status', 'yes') == 'yes' ? 'Yes (Active)' : 'No (Disabled)' }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="vpn_modes" class="form-select @error('vpn_modes') is-invalid @enderror">
                                    <option value="not_allowed" {{ old('vpn_modes', 'not_allowed') == 'not_allowed' ? 'selected' : '' }}>Not Allowed</option>
                                    <option value="allowed" {{ old('vpn_modes') == 'allowed' ? 'selected' : '' }}>Allowed</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="vpn_required_in_task_only" class="form-select @error('vpn_required_in_task_only') is-invalid @enderror">
                                    <option value="no" {{ old('vpn_required_in_task_only', 'no') == 'no' ? 'selected' : '' }}>No</option>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('allowed_country', 'us,uk,au,bangladesh,india') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="registration_status" class="form-select @error('registration_status') is-invalid @enderror">
                                    <option value="open" {{ old('registration_status', 'open') == 'open' ? 'selected' : '' }}>Open</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="same_device_login" class="form-select @error('same_device_login') is-invalid @enderror">
                                    <option value="no" {{ old('same_device_login', 'no') == 'no' ? 'selected' : '' }}>No</option>
                            ...
                            <div class="col-12">
                                ...
                                <select name="maintenance_mode" class="form-select @error('maintenance_mode') is-invalid @enderror">
                                    <option value="no" {{ old('maintenance_mode', 'no') == 'no' ? 'selected' : '' }}>No</option>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('admob_interstitial_id') }}"
                                       placeholder="ca-app-pub-XXXXXXXXXXXXXXXX/YYYYYYYYYY">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('admob_rewarded_interstitial_id') }}"
                                       placeholder="ca-app-pub-XXXXXXXXXXXXXXXX/YYYYYYYYYY">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="admob_status" class="form-select @error('admob_status') is-invalid @enderror">
                                    <option value="0" {{ old('admob_status', '0') == '0' ? 'selected' : '' }}>Disabled</option>
                                    <option value="1" {{ old('admob_status') == '1' ? 'selected' : '' }}>Enabled</option>
                                </select>
                                @error('admob_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
            ...
            <div class="col-12">
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-success btn-lg">
                        <i class="bi bi-check-circle me-2"></i>Save App Settings
                    </button>
                </div>
            </div>
