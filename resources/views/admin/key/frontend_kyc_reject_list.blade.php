...
<!-- Image Preview Modal -->
<div class="modal fade" id="rejectedImageModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="rejectedPreviewImage" class="img-fluid rounded">
            </div>
        </div>
    </div>
</div>
...
<!-- Live Search Script -->
<script>
document.getElementById('rejectedKycSearch').addEventListener('keyup', function () {
    let value = this.value.toLowerCase();
    document.querySelectorAll('#rejectedKycTable tbody tr').forEach(row => {
...
document.querySelectorAll('.kyc-img').forEach(img => {
    img.addEventListener('click', function () {
        document.getElementById('rejectedPreviewImage').src = this.dataset.img;
        new bootstrap.Modal(
            document.getElementById('rejectedImageModal')
        ).show();
    });
});
</script>
