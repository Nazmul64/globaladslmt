    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 text-dark fw-bold">
                <i class="bi bi-box-seam me-2 text-primary"></i>Create New Package
            </h4>
            <p class="text-muted small mb-0">Configure earning package rates, daily limits, ad breaks and package banner/photo</p>
        </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('package.store') }}" method="POST" enctype="multipart/form-data" id="packageForm">
                        @csrf

                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label fw-semibold text-dark">Package Name <span class="text-danger">*</span></label>
                                <input type="text" name="package_name" class="form-control form-control-lg" placeholder="e.g. Platinum Membership" value="{{ old('package_name') }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="price" class="form-control" placeholder="99.00" value="{{ old('price') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text bg-light">$</span>
                                    <input type="number" step="0.01" name="daily_income" class="form-control" placeholder="1.50" value="{{ old('daily_income') }}" required>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label fw-semibold text-dark">Daily Limit (Ads/Tasks) <span class="text-danger">*</span></label>
                                <input type="number" name="daily_limit" class="form-control" placeholder="25" value="{{ old('daily_limit') }}" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label fw-semibold text-dark">Validity (Days) <span class="text-danger">*</span></label>
                                <input type="text" name="validity" class="form-control" placeholder="365" value="{{ old('validity') }}" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label fw-semibold text-dark">Ad Break (Seconds) <span class="text-danger">*</span></label>
                                <input type="number" name="ad_brack" class="form-control" placeholder="5" value="{{ old('ad_brack', 5) }}" required>
                            </div>

                            {{-- File Upload Area --}}
                            <div class="col-md-12 mt-4">
                                <label class="form-label fw-semibold text-dark">Package Photo / Banner</label>
                                <div class="border-2 border-dashed rounded-3 p-4 text-center bg-light" id="dropZone" style="border-style: dashed; cursor: pointer;">
                                    ...
                                    <span class="fw-bold text-dark d-block">Click to browse or drag & drop package photo</span>
                        ...
                        <div class="d-flex gap-2 mt-4 pt-3 border-top">
                            <button type="submit" class="btn btn-primary px-4 shadow-sm" id="submitBtn">
                                <i class="bi bi-check-lg me-1"></i> Create Package
                            </button>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-3 sticky-top" style="top: 20px;">
                <div class="card-header bg-white border-bottom py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="bi bi-eye me-2 text-info"></i>Photo Live Preview
                    </h6>
                </div>
                <div class="card-body p-4 text-center">
                    {{-- Selected Preview --}}
                    <div id="newPreviewContainer" class="p-3 rounded-3 border bg-white shadow-sm mb-3 d-none">
                        <span class="badge bg-success mb-2">Live Selected Preview</span>
                        <img id="packagePreviewImage" src="#" alt="Package Preview" class="img-fluid rounded shadow-sm" style="max-height: 200px; width: 100%; object-fit: contain;">
                    </div>
                    ...
                    <div id="placeholderContainer" class="p-4 rounded-3 border bg-light text-muted">
                        ...
                        <span class="small">No image selected yet.<br>Select or drop any image (JPG, PNG, GIF, SVG, WEBP) to see live preview here.</span>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFilePreview(file) {
        ...
        reader.onload = function(e) {
            ...
            if (typeof toastr !== 'undefined') {
                toastr.info('Image loaded for preview! Click "Create Package" to save.');
            }
        };
