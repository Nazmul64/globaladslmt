...
public function agent_dashboard()
{
    ...
    $deposit_income = Userdepositerequest::where('agent_id', $auth_user_id)->sum('agent_commission');
    $withdraw_income = UserWidhrawrequest::where('agent_id', $auth_user_id)->sum('agent_commission');
